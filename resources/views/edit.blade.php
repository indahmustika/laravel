						...
						<div class="col-xl-12 col-lg-7">
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h5 class="m-0 text-primary">Edit Article</h5>
								</div>
								<div class="card-body">
											...
											<table class="table table-sm table-borderless" width="100%" cellspacing="0">
												<tr>
													<div class="form-grup">
														...
														<td width="85%"><input class="form-control" type="text" name="title" placeholder="Article Title" required="required" value="{{$data->title}}"></td>
													</div>
												</tr>
												<tr>
													<div class="form-grup">
														<td width="15%"><label class="control-label">Thumbnail</label></td>
														<td width="85%"><input class="form-control" type="text" name="thumbnail" placeholder="Thumbnail Link" required="required" value="{{$data->thumbnail}}"></td>
													</div>
												</tr>
												<tr>
													<div class="form-grup">
														<td width="15%"><label class="control-label">Excerpt</label></td>
														<td width="85%"><textarea class="form-control" name="excerpt" cols="110" rows="5" required="required">{{$data->excerpt}}</textarea></td>
													</div>
												</tr>
												<tr>
													<div class="form-grup">
														<td width="15%"><label class="control-label">Content</label></td>
														<td width="85%"><textarea name="content" class="ckeditor" id="ckedtor" cols="110" rows="20" placeholder="Article Content" required="required">{{$data->content}}</textarea></td>
													</div>
												</tr>
												<tr>
													<div class="form-grup">
